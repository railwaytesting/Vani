...
class EducationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Apple system red — maps to red_D in dark mode
    ...
    return ObjectivePageBase(
      ...
      stats: [
        ObjStatData(
          value:       l.t('edu_stat1_val'),
          label:       l.t('edu_stat1_label'),
          description: l.t('edu_stat1_desc'),
          color:       kCrimson,
        ),
        ObjStatData(
          value:       l.t('edu_stat2_val'),
          label:       l.t('edu_stat2_label'),
          description: l.t('edu_stat2_desc'),
          color:       kCrimson,
        ),
        ObjStatData(
          value:       l.t('edu_stat3_val'),
          label:       l.t('edu_stat3_label'),
          description: l.t('edu_stat3_desc'),
          color:       kAmber,
        ),
        ObjStatData(
          value:       l.t('edu_stat4_val'),
          label:       l.t('edu_stat4_label'),
          description: l.t('edu_stat4_desc'),
          color:       accent,
        ),
      ],
      sections: [
        ObjSection(
          title:  l.t('edu_s1_title'),
          isDark: isDark,
          child: Column(children: [
            ObjInfoCard(
              title:  l.t('edu_s1_c1_title'),
              body:   l.t('edu_s1_c1_body'),
              icon:   Icons.child_care_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('edu_s1_c2_title'),
              body:   l.t('edu_s1_c2_body'),
              icon:   Icons.mic_off_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('edu_s1_c3_title'),
              body:   l.t('edu_s1_c3_body'),
        ...
        ObjSection(
          title:  l.t('edu_s3_title'),
          isDark: isDark,
          child: Column(children: [
            ObjInfoCard(
              title:  l.t('edu_s3_c1_title'),
              body:   l.t('edu_s3_c1_body'),
              icon:   Icons.loop_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('edu_s3_c2_title'),
              body:   l.t('edu_s3_c2_body'),
              icon:   Icons.class_outlined,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('edu_s3_c3_title'),
              body:   l.t('edu_s3_c3_body'),
            ...
            ObjQuoteBlock(
              quote:  l.t('edu_quote'),
              source: l.t('edu_quote_src'),
              accent: accent, isDark: isDark,
            ),
          ]),
        ),
        ObjSection(
          title:  l.t('edu_s4_title'),
          isDark: isDark,
          child: Column(children: [
