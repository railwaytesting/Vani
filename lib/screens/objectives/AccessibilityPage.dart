...
class AccessibilityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Apple system indigo — maps to indigo_D in dark mode via ObjectivePageBase
    const accent = Color(0xFF5856D6);
    ...
    return ObjectivePageBase(
      ...
      stats: [
        ObjStatData(
          value:       l.t('acc_stat1_val'),
          label:       l.t('acc_stat1_label'),
          description: l.t('acc_stat1_desc'),
          color:       accent,
        ),
        ObjStatData(
          value:       l.t('acc_stat2_val'),
          label:       l.t('acc_stat2_label'),
          description: l.t('acc_stat2_desc'),
          color:       kCrimson,
        ),
        ObjStatData(
          value:       l.t('acc_stat3_val'),
          label:       l.t('acc_stat3_label'),
          description: l.t('acc_stat3_desc'),
          color:       kCrimson,
        ),
        ObjStatData(
          value:       l.t('acc_stat4_val'),
          label:       l.t('acc_stat4_label'),
          description: l.t('acc_stat4_desc'),
          color:       kAmber,
        ),
      ],
      sections: [
        ObjSection(
          title:  l.t('acc_s1_title'),
          isDark: isDark,
          child: Column(children: [
            ObjInfoCard(
              title:  l.t('acc_s1_c1_title'),
              body:   l.t('acc_s1_c1_body'),
              icon:   Icons.record_voice_over_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('acc_s1_c2_title'),
              body:   l.t('acc_s1_c2_body'),
              icon:   Icons.map_outlined,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('acc_s1_c3_title'),
              body:   l.t('acc_s1_c3_body'),
        ...
        ObjSection(
          title:  l.t('acc_s3_title'),
          isDark: isDark,
          child: Column(children: [
            ObjInfoCard(
              title:  l.t('acc_s3_c1_title'),
              body:   l.t('acc_s3_c1_body'),
              icon:   Icons.speed_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('acc_s3_c2_title'),
              body:   l.t('acc_s3_c2_body'),
            ...
            ObjQuoteBlock(
              quote:  l.t('acc_quote'),
              source: l.t('acc_quote_src'),
              accent: accent, isDark: isDark,
            ),
          ]),
        ),
        ObjSection(
          title:  l.t('acc_s4_title'),
          isDark: isDark,
          child: Column(children: [
