...
class PrivacyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Apple system orange — maps to orange_D in dark mode
    ...
    return ObjectivePageBase(
      ...
      stats: [
        ObjStatData(
          value:       l.t('priv_stat1_val'),
          label:       l.t('priv_stat1_label'),
          description: l.t('priv_stat1_desc'),
          color:       accent,
        ),
        ObjStatData(
          value:       l.t('priv_stat2_val'),
          label:       l.t('priv_stat2_label'),
          description: l.t('priv_stat2_desc'),
          color:       kCrimson,
        ),
        ObjStatData(
          value:       l.t('priv_stat3_val'),
          label:       l.t('priv_stat3_label'),
          description: l.t('priv_stat3_desc'),
          color:       kCrimson,
        ),
        ObjStatData(
          value:       l.t('priv_stat4_val'),
          label:       l.t('priv_stat4_label'),
          description: l.t('priv_stat4_desc'),
          color:       kAmber,
        ),
      ],
      sections: [
        ObjSection(
          title:  l.t('priv_s1_title'),
          isDark: isDark,
          child: Column(children: [
            ObjInfoCard(
              title:  l.t('priv_s1_c1_title'),
              body:   l.t('priv_s1_c1_body'),
              icon:   Icons.phone_android_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('priv_s1_c2_title'),
              body:   l.t('priv_s1_c2_body'),
              icon:   Icons.cloud_off_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('priv_s1_c3_title'),
              body:   l.t('priv_s1_c3_body'),
        ...
        ObjSection(
          title:  l.t('priv_s3_title'),
          isDark: isDark,
          child: Column(children: [
            ObjInfoCard(
              title:  l.t('priv_s3_c1_title'),
              body:   l.t('priv_s3_c1_body'),
              icon:   Icons.memory_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjInfoCard(
              title:  l.t('priv_s3_c2_title'),
              body:   l.t('priv_s3_c2_body'),
              icon:   Icons.verified_user_rounded,
              accent: accent, isDark: isDark,
            ),
            const SizedBox(height: 12),
            ObjQuoteBlock(
              quote:  l.t('priv_quote'),
              source: l.t('priv_quote_src'),
              accent: accent, isDark: isDark,
            ),
          ]),
        ),
        ObjSection(
          title:  l.t('priv_s4_title'),
          isDark: isDark,
          child: Column(children: [
